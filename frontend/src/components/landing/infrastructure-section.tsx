...
// Originalmente describe edge network / latency de una plataforma de hosting.
// Puede adaptarse en el futuro para mostrar arquitectura de agentes o deployment de Orquesta.
